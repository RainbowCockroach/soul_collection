...
- **Tag**: Tags with name, slug, background color, and text color (no vanilla mode logic; censorship is managed separately in `vanilla-mode-censor.json`)
...
- Vanilla mode censorship (EditorVanillaModeCensor.tsx)
